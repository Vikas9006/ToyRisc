...
public class Execute implements Element{
	...
	public void performEX() {
		if (OF_EX_Latch.isEX_enable()) {
			// if (OF_EX_Latch.get_isEXbusy())
			// {
			// 	System.out.println(OF_EX_Latch.get_opcode());
			// 	return;
			// }
			...
			if (opcode == -1) {
				...
				if (controlUnit.isDiv() || controlUnit.isDivi())
				{
					latency = Configuration.divider_latency;
				}
				else if (controlUnit.isMul() || controlUnit.isMuli())
				{
